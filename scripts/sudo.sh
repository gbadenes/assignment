...
date > /etc/guillem_box_build_time

SSH_USER=${SSH_USERNAME:-guillem}
SSH_PASS=${SSH_PASSWORD:-guillem}
SSH_USER_HOME=${SSH_USER_HOME:-/home/${SSH_USER}}
VAGRANT_INSECURE_KEY="ssh-rsa  guillem insecure public key"
...
if [ "$INSTALL_VAGRANT_KEY" = "true" ] || [ "$INSTALL_VAGRANT_KEY" = "1" ]; then
    ...
    echo "${SSH_USER}        ALL=(ALL)       NOPASSWD: ALL" >> /etc/sudoers.d/guillem
    chmod 440 /etc/sudoers.d/guillem
    ...
    echo "==> Installing guillem key"
    mkdir $SSH_USER_HOME/.ssh
    chmod 700 $SSH_USER_HOME/.ssh
    cd $SSH_USER_HOME/.ssh

    # https://raw.githubusercontent.com/mitchellh/guillem/master/keys/guillem.pub
